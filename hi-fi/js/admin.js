$(document).ready(function() {
	...
	$('.froala').froalaEditor({
		...
		placeholderText: '',
		theme: 'custom',
		toolbarButtons: ['bold', 'italic', 'underline', 'fontSize', 'fontFamily', '|', 'paragraphFormat', 'align', 'formatUL', 'formatOL', 'indent', 'outdent', 'insertLink', 'insertImage', 'undo', 'redo' , 'help', 'html'],
		toolbarButtonsMD: ['bold', 'italic', 'underline', 'fontSize', 'fontFamily', '|', 'paragraphFormat', 'align', 'formatUL', 'formatOL', 'indent', 'outdent', 'insertLink', 'insertImage', 'undo', 'redo' , 'help', 'html'],
		toolbarButtonsSM: ['bold', 'italic', 'underline', 'fontSize', 'fontFamily', '|', 'paragraphFormat', 'align', 'formatUL', 'formatOL', 'indent', 'outdent', 'insertLink', 'insertImage', 'undo', 'redo' , 'help', 'html'],
		toolbarButtonsXS: ['bold', 'italic', 'underline', 'fontSize', 'fontFamily', '|', 'paragraphFormat', 'align', 'formatUL', 'formatOL', 'indent', 'outdent', 'insertLink', 'insertImage', 'undo', 'redo' , 'help', 'html']
	});
